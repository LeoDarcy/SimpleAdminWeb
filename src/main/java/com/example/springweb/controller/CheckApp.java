...
public class CheckApp {
    ...
    public String CheckIn(@RequestParam(name="id", required=false, defaultValue="161220002") String id, Model model) {
    ...
    public String CheckIn(@RequestParam(name="namelegel")String namelegel,@RequestParam(name = "kindcorrect")String kindcorrect,
                          @RequestParam(name="comment")String comment,@RequestParam(name="level")String level,
                          @RequestParam(name="id", required=false, defaultValue="161220002") String id,Model model){
